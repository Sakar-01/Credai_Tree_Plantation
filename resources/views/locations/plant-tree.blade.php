...
window.initMap = function initMap() {
    ...
    marker = new google.maps.Marker({
        ...
        map: map,
        draggable: true,
        title: 'Tree Planting Spot',
        icon: {
            url: 'data:image/svg+xml;charset=UTF-8,<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="%2300A000"><path d="M12 2L13.09 8.26L20 9L13.09 9.74L12 16L10.91 9.74L4 9L10.91 8.26L12 2Z"/></svg>',
